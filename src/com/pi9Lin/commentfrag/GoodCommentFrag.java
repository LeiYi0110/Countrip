...
public class GoodCommentFrag extends BaseFragment {
	private View view;
	ListView page_list;
	...
	int sumOfComment = 4;
	int[] resImgFace={}; 
//	int[] resUploadImg={R.drawable.up_1,R.drawable.up_2,R.drawable.up_3,R.drawable.up_1};
	String[] resLevel = { "路人甲", "一级吃货", "二级吃货", "二级吃货" };
	String[] resComment = {
			"本章内容是 好评android.widget.RatingBar，译为评分条，版本为Android 2.2 r1，翻译来自madgoawallace2010欢迎大家访问他们的博客：http://madgoat.cn/、http://blog.csdn.net/springiscoming2008，再次感谢adgoawallace20期待你加入Android中文翻译组，联系我over140@gmail.com",
			"本章内容是 好评android.widget.RatingBar，译为评分条，版本为Android 2.2 r1，翻译来自madgoawallace2010欢迎大家访问他们的博客：http://madgoat.cn/、http://blog.csdn.net/springiscoming2008，再次感谢adgoawallace20期待你加入Android中文翻译组，联系我over140@gmail.com",
			"本章内容是 好评android.widget.RatingBar，译为评分条，版本为Android 2.2 r1，翻译来自madgoawallace2010欢迎大家访问他们的博客：http://madgoat.cn/、http://blog.csdn.net/springiscoming2008，再次感谢adgoawallace20期待你加入Android中文翻译组，联系我over140@gmail.com",
			"本章内容是 好评android.widget.RatingBar，译为评分条，版本为Android 2.2 r1，翻译来自madgoawallace2010欢迎大家访问他们的博客：http://madgoat.cn/、http://blog.csdn.net/springiscoming2008，再次感谢adgoawallace20期待你加入Android中文翻译组，联系我over140@gmail.com" };
