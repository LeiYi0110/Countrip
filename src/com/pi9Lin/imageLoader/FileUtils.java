...
public class FileUtils {
	 ...
	 * 保存Image的目录名
	 */
	private final static String FOLDER_NAME = "/CountripImage";
	private int width;
	 ...
	 * @throws IOException
	 */
	public Bitmap saveBitmap(String fileName, InputStream in) throws IOException {
		String path = getStorageDirectory();
		File folderFile = new File(path);
		if (!folderFile.exists()) {
			folderFile.mkdir();
	...
	public Bitmap getBitmap(String fileName) {
		return BaseActivity.decodeSampledBitmapFromResource(
